# El Ordenamiento de burbuja (BubbleSort) es un algoritmo de ordenamiento simple. 
# El mismo funciona revisando cada elemento de la lista a ordenar con el que le sigue, 
# cambiándolos de posición si están en un orden incorrecto (n>n+1). 
# Es necesario repetir este proceso varias veces hasta que no se necesiten más cambios, 
# lo que significa que la lista quedó ordenada.
