...
# con la diferencia que en este el ordenamiento se realiza en ambas direcciones, 
# comprobando que el primero sin ordenar sea el menor y el ultimo sin ordenar sea el mayor y 
# acomodando así en su respectivo lugar cada uno de los elementos.
